<div class="modal-window-playlist hide">
    <div class="modal-window-playlist__inner">
        <div class="modal-window-playlist__top">
            <div class="playlist__poster modal-window-playlist__poster">
                <img class="playlist__poster-image modal-window-playlist__poster-image" src="" alt="Постер плейлиста">
            </div>
